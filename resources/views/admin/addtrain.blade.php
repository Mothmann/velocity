    ...
    <div class="row-1 my-4">
        <div class="col-1-md-12">
            <div class="form-group">
                <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#addTrains">Create train</button>
            </div>
            <div class="box">
               <div class="card-body">
                      <table class="table">
                            ...
                            <tbody>
                              @foreach($trains as $train)
                                <tr>
                                   <td>{{$train->id}}</td>
                                   <td>{{$train->type}}</td>
                                   <td>{{$train->Max_capacity}}</td>
                                   <td>{{$train->Driver}}</td>
                                   <td>
                                      <a href="{{route('admin.trains.edit', ['id' => $train->id])}}"class="btn btn-warning"><i class="fa fa-edit"></i></a>
                                      <a href="/admin/deletetrain?id={{ $train->id }}" class="btn btn-danger"><i class="far fa-trash-alt"></i></a>
                                   </td>
                                </tr>
                              @endforeach
                            </tbody>
        ...
        <div class="modal fade" id="addTrains" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">

          <!-- Modal content-->
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title" id="myModalLabel">Add trains</h4>
